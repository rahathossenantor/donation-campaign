...
const Statistics = () => {
    ...
    const data = [
        ...
        { name: "Your Donation", value: donatedCards.length }
    ];
        ...
        <div className="md:container md:mx-auto 2xl:px-0 xl:px-0 lg:px-5 md:px-5 px-5">
            <div className="py-10">
                ...
                <div className="flex gap-5 justify-center py-5">
                    <p className="flex gap-2 items-center">Your Donation <span className="h-4 w-20 bg-[#00C49F]"></span></p>
                    <p className="flex gap-2 items-center">Total Donation <span className="h-4 w-20 bg-[#FF444A]"></span></p>
                </div>
            </div>
        </div>
    );
